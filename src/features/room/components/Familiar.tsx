    ...
    >
      ...
      >
        ...
        <p className="text-base leading-8 text-justify">
          Pensada para parejas o viajeros que buscan una experiencia tranquila,
          esta habitación matrimonial ofrece una cama Queen que garantiza el
          descanso ideal. Con capacidad para dos personas, su ambiente cálido y
          acogedor crea el espacio perfecto para relajarse y disfrutar de una
          estadía placentera.
        </p>
