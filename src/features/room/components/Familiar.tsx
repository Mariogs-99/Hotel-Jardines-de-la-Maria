    ...
    <section className={`grid ${reversed ? "md:grid-cols-[40vw_60vw]" : "md:grid-cols-[60vw_40vw]"} overflow-hidden `}> {/*TODO: revisar que sobresale */}
        <>
          <article className={`${reversed ? 'order-1' : 'order-2'} px-10 md:px-20 flex flex-col justify-evenly gap-8  md:gap-0`}>
            <h1 className="text-3xl md:text-5xl font-title pb-0 text-primary-brown text-start">Habitación Familiar</h1>
            ...
            <p className="text-base leading-8 text-justify">
              Esta habitación cuenta con una sala y una terraza con vista de una de nuestras plazas icónicas.
              La arquitectura colonial de la habitación se complementa con un toque moderno
            </p>
